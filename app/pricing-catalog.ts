...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    features: ["1 business website", "1 business location or service area", "Automated website audit", "Google Search Console and GA4 connection", "Local keyword discovery", "Competitor and content-gap research", "Up to 100 tracked keywords", "Monthly technical crawl", "Prioritized opportunity recommendations", "Flexible foundational execution capacity", "Plain-language approval requests", "Metadata, internal-link, schema, and page-improvement workflows", "Monthly outcome report", "Email support"],
  ...
  },
  {
    ...
    features: ["Everything in Essentials", "Up to 3 locations or approved service areas", "Weekly technical crawling", "Up to 500 tracked keywords", "Daily Search Console and analytics synchronization", "Advanced competitor-gap monitoring", "Flexible guided execution capacity", "New service and location page briefs", "Content refresh and conversion recommendations", "Google Business Profile evidence", "CMS or GitHub preparation through supported connections", "Deployment previews", "Technical SEO and schema validation", "Lighthouse, sitemap, robots, and broken-link checks", "Rollback protection for supported connections", "Lead and conversion attribution", "Priority support"],
...
export const pricingAddOns = [
  ...
  ["Additional managed execution capacity", "$15 per unit, prepaid"],
...
export const pricingFaq = [
  ...
  ["What is included in the Founding Beta?", "The beta keeps the plan's bounded execution capacity, includes a controlled HD SEO data and AI allowance, and measures delivery for 90 days. The discounted price applies to the first monthly billing period; normal renewal pricing is shown before checkout."],
  ...
  ["How is execution capacity used?", "HD SEO allocates it to the highest-confidence return available. It can concentrate the month on one major campaign or divide capacity across smaller improvements. Capacity is earned only after verified delivery; stopped work and retries do not count."],
...
export const agentServicePlans: AgentServicePlan[] = [
  {
    ...
    features: ["Everything in Growth Copilot", "Specialized SEO agent team", "Automatic evidence collection and opportunity selection", "Flexible monthly execution capacity", "Capacity can fund one major campaign or several smaller improvements", "One major page build or comprehensive refresh monthly", "CMS or GitHub implementation through supported connections", "Preview and plain-language approval workflow", "Technical, schema, link, sitemap, robots, and deployment validation", "Rollback readiness", "Weekly monitoring", "Lead and revenue attribution", "30 minutes of human strategy review monthly"],
    cta: "Start Autopilot",
  ...
  },
  {
    ...
    features: ["Everything in Autopilot", "Expanded flexible execution capacity", "Portfolio optimization across major campaigns and smaller improvements", "Two major page builds or comprehensive refreshes monthly", "Priority agent execution", "Daily evidence synchronization where providers support it", "Advanced conversion, call, CRM, revenue, and gross-profit attribution", "Multi-location opportunity prioritization", "60 minutes of human strategy review monthly"],
