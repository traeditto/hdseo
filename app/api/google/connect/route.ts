...
export async function GET(request:Request){
  try{
    ...
    const context=await requireLiveAgencyProject({projectId,permission:"integrations.manage"}),id=crypto.randomUUID(),nonce=crypto.randomUUID(),returnUrl="/portal/agency?tab=Websites&gsc=connected";
