...
export const agentServicePlans={
  starter:{label:"Starter Autopilot",monthlyActionLimit:6,monthlyProviderBudget:15,humanReviewMinutes:0,cycleCadenceHours:168},
  growth:{label:"Growth Autopilot",monthlyActionLimit:12,monthlyProviderBudget:35,humanReviewMinutes:30,cycleCadenceHours:72},
  pro:{label:"Pro + Human Review",monthlyActionLimit:24,monthlyProviderBudget:75,humanReviewMinutes:120,cycleCadenceHours:24},
  agency_core:{label:"Agency Managed Core",monthlyActionLimit:12,monthlyProviderBudget:35,humanReviewMinutes:0,cycleCadenceHours:72},
  agency_scale:{label:"Agency Managed Scale",monthlyActionLimit:24,monthlyProviderBudget:75,humanReviewMinutes:60,cycleCadenceHours:24},
} as const;
