export type ApiErrorCode =
  ...
  | "PREVIEW_VALIDATION_RETRY"
  | "PREVIEW_CONTINUATION_EXHAUSTED"
  | "PREVIEW_QA_FAILED"
  | "PRODUCTION_VALIDATION_RETRY"
  | "BETA_ALREADY_REDEEMED"
  | "BETA_ENROLLMENT_CLOSED"
  | "BETA_TIER_FULL"
  | "BETA_COUPON_MISMATCH"
  | "BETA_CONFIGURATION_INVALID"
  | "MODEL_REQUEST_COST_LIMIT"
  | "PROJECT_DAILY_MODEL_BUDGET_EXCEEDED"
  | "PLATFORM_DAILY_MODEL_BUDGET_EXCEEDED"
  | "PROVIDER_BUDGET_EXCEEDED"
  | "MAJOR_PAGE_CAPACITY_EXCEEDED"
